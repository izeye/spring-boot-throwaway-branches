...
public class SpringProfileTestConfigProfile2Tests {
	...
	public void testBeanForProfile1() {
		...
		this.context.getBean("beanForProfile1");
	}

	@Test
	public void testBeanForNonProfile1() {
		assertThat(this.context.getBean("beanForNonProfile1")).isEqualTo("!profile1");
	}
